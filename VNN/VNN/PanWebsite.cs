...
namespace VNN
{
    public class PanWebsite
    {
                    ...
                    Task.Factory.StartNew(() =>
                    {
                        if (context.Request.IsWebSocketRequest)
                        {
                            Task.Factory.StartNew(async () =>
                            {
                                ...
                                //onWebSocketRequest.Invoke(webSocket);
        ...
        public void WebSocketSend(List<WebSocket> webSockets, string message)
        {
        ...
        {
            WebSocketSend(this.WebSockets, message);
        }
    }
    ...
    public class PanResponse
    {
        ...
        public static PanResponse ReturnEmpty(List<PanCookie> cookies = null)
        {
    ...
    //    public PanWebSocket(OnReceive onReceive)
    //    {
